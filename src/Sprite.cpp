...
namespace sb
{
	Mesh Sprite::SpriteMesh({
		Vertex(Vector2f(0, 0), Color(1, 1, 1, 1), Vector2f(0, 0)),
		Vertex(Vector2f(1, 0), Color(1, 1, 1, 1), Vector2f(1, 0)),
		Vertex(Vector2f(0, 1), Color(1, 1, 1, 1), Vector2f(0, 1)),
		Vertex(Vector2f(1, 1), Color(1, 1, 1, 1), Vector2f(1, 1))
